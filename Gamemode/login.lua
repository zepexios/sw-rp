...
function SWWritePlayerData( table )	//stores the content of "table" ( a param, :O)
...
function SWSetPlayerData( ply )		//player data, and any files can access this
	...
	PlayerData[ply:UniqueID()] = {	
		...
		RifleXP = SWGetRifleXP(), 		// There has to be a function argument here getting the rifle xp till then this does nothing. because its a GM function im pretty sure
